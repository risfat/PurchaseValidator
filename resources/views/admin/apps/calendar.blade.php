...
@section('title', 'Calendar - ' . $site_name . ' | Admin Dashboard')

@push('styles')


    <!-- Plugin css -->
    <link href="{{ asset('admin/libs/fullcalendar/main.min.css') }}" rel="stylesheet" type="text/css" />
...
@push('scripts')
    ...
    <script src="{{ asset('admin/libs/fullcalendar/main.min.js') }}"></script>

...
@section('title', 'Add New Product - ' . $site_name . ' | Admin Dashboard')
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="product-name" name="name" form="product-form"
                                        class="form-control" placeholder="e.g : Apple iMac" value="{{ old('name') }}"
                                        required>
                                </div>
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h5 class="text-uppercase mt-0 mb-3 bg-light p-2">Purchased Customers</h5>
                            </div>
                        </div> <!-- end card -->
